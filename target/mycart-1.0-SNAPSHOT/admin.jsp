                ...
                <div class="col-md-4">
                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            <div class="container">
                                <img style="max-width: 125px;" class="img-fluid rounded-circle" src="img/users.jpg" alt="user_icon">
                ...
                <div class="col-md-4">
                    ...
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            ...
                            <div class="container">
                                <img style="max-width: 125px;" class="img-fluid rounded-circle" src="img/list.jpg" alt="category_icon">
                ...
                <div class="col-md-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="container">
                                <img style="max-width: 125px;" class="img-fluid rounded-circle" src="img/product1.jpg" alt="product_icon">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card" data-toggle="modal" data-target="#add-category-modal">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="container">
                                <img style="max-width: 125px;" class="img-fluid rounded-circle" src="img/add.jpg" alt="add_category_icon">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card" data-toggle="modal" data-target="#add-product-modal">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="container">
                                <img style="max-width: 125px;" class="img-fluid rounded-circle" src="img/add.jpg" alt="add_product_icon">
